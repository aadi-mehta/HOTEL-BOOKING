...
CREATE TABLE `hotelbookingmanagement`.`employees` (`emp_id` INT NOT NULL AUTO_INCREMENT ,
 `emp_name` VARCHAR(50) NULL , `emp_phone` INT NULL , `emp_salary` INT NULL , `emp_gender` VARCHAR(10) NULL ,
  PRIMARY KEY (`emp_id`)) ENGINE = InnoDB;
  INSERT INTO `employees` (`emp_id`, `emp_name`, `emp_phone`, `emp_salary`, `emp_gender`, `emp_designatiom`) VALUES 
  (NULL, 'aditya', '955812577', '20000', 'Male', 'Manager');
  INSERT INTO `employees` (`emp_id`, `emp_name`, `emp_phone`, `emp_salary`, `emp_gender`, `emp_designatiom`) VALUES 
  (NULL, 'nitin', '955812588', '15000', 'Male', 'Clerk');
  INSERT INTO `employees` (`emp_id`, `emp_name`, `emp_phone`, `emp_salary`, `emp_gender`, `emp_designatiom`) VALUES 
  (NULL, 'pratik', '912812577', '12000', 'Male', 'Chef');
  INSERT INTO `employees` (`emp_id`, `emp_name`, `emp_phone`, `emp_salary`, `emp_gender`, `emp_designatiom`) VALUES 
  (NULL, 'radhika', '755812588', '11000', 'Female', 'Receptionist');
  INSERT INTO `employees` (`emp_id`, `emp_name`, `emp_phone`, `emp_salary`, `emp_gender`, `emp_designatiom`) VALUES
   (NULL, 'sagnik', '912814577', '12000', 'Male', 'Event Planner');
